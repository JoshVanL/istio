...
func NewSecretFetcher(ingressGatewayAgent bool, endpoint, caProviderName string, tlsFlag bool,
	tlsRootCert []byte, vaultAddr, vaultRole, vaultAuthPath, vaultSignCsrPath, certManagerNamespace string) (*SecretFetcher, error) {
	ret := &SecretFetcher{}
	...
	if ingressGatewayAgent {
		...
		caClient, err := ca.NewCAClient(endpoint, caProviderName, tlsFlag, tlsRootCert,
			vaultAddr, vaultRole, vaultAuthPath, vaultSignCsrPath, certManagerNamespace)
		if err != nil {
