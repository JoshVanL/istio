...
func NewCertmanagerClient(namespace, issuerName, issuerKind string, tls bool) (caClientInterface.Client, error) {
	...
	log.Infof("cert-manager: using %s:%s", issuerKind, issuerName)
